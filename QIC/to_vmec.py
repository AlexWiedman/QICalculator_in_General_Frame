...
import numpy as np
from .curve_frame_to_cylindrical import curvilinear_frame_to_cylindrical
...
def to_vmec(self, filename, r=0.1, params=dict(), ntheta=20, ntorMax=14):
    ...
    file_object.write("! This &INDATA namelist was generated by QICalculator_in_General_Frame: github.com/AlexWiedman/QICalculator_in_General_Frame\n")
    ...
    file_object.write('! Near-axis parameters:  radius r = '+str(r)+', B0 = not yet implemented'+'\n')
