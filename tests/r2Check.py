...
fx0_qsc = np.matmul(d_d_varphi,X20) - qsc_stel.torsion * dldp * Y20 + 2*I2*dldp/Bbar * Y20 + 4*G0*Z2c/Bbar * Y2s - 4*G0*Z2s/Bbar * Y2c
...
fy0_qsc = (k3*dldp - 2*I2*dldp/Bbar)*X20
fys_qsc
fyc_qsc
